...
import ChatBubbleOutlineRoundedIcon from "@material-ui/icons/ChatBubbleOutlineOutlined";
...
function Post({ Id, question, imageUrl, timestamp, users }) {
    ...
    const [IsmodalOpen, setIsModalOoen] = useState(false);
               ...
               <div className = "post__question">
                ...
                >
                    ...
                    <div className="modal__button">
                        <button className="cancel" onClick={() => setIsModalOoen(false)}>
                            cancel
                        </button>
